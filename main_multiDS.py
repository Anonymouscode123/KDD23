...
def process_protoreput2(clients, server):
    print("\nDone setting up prototype devices.")
    print("Running fed prototype ...")
    frame = run_protoreput2(clients, server, args.num_rounds, args.device, samp=None)
...
if __name__ == '__main__':
    ...
    num_threads = '32'  # 高峰期用‘8’，平时‘16’，非常空闲用‘32’
    ...
    #parser.add_argument('--prototype', type=bool, default=False)
    ...
    args.device = "cuda:9" if torch.cuda.is_available() else "cpu"
    ...
    process_prototype(clients=copy.deepcopy(init_clients), server=copy.deepcopy(init_server))
