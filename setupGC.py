...
def prepareData_multiDS(datapath, group='small', batchSize=32, convert_x=False, seed=None):
    ...
    for data in datasets:
        ...
        # with open(f'/home/panchenglu/gcc2/GCFL/data/TUDataset/{data}/raw/{data}_A.txt', 'r') as f:
        #     edges = f.read().splitlines()
        # edges = [tuple(map(int, e.replace(" ", "").split(","))) for e in edges]
        # #print("edges", len(edges))

        # with open(f'/home/panchenglu/gcc2/GCFL/data/TUDataset/{data}/raw/{data}_graph_indicator.txt', 'r') as f:
        #     g = f.readlines()
        # g = [int(i) for i in g]
