...
class Server():
    def __init__(self, model, device):
        ...
        self.model_cache = []
        self.vocab = {}#记录每个motif有多少个
        
        self.whole_node_count = {}
        self.num_client = {}#记录每个motif有多少个client有
        self.global_prototype = {}
        self.global_prototype_code = {}#给motif编号：motif：code
        self.weight = {}
        self.code_prototype = {}#motif编号：prototype
        self.code = {} # code:motif
